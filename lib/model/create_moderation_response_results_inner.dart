...
class CreateModerationResponseResultsInner {
  ...
  @override
  String toString() => 'CreateModerationResponseResultsInner[flagged=$flagged, categories=$categories, categoryScores=$categoryScores]';
  ...
  static Map<String, List<CreateModerationResponseResultsInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreateModerationResponseResultsInner.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
