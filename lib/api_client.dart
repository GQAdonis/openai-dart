  ...
  static dynamic _deserialize(dynamic value, String targetType, {bool growable = false}) {
    try {
      switch (targetType) {
        ...
        case 'CreateAnswerRequestStop':
          return CreateAnswerRequestStop.fromJson(value);
        case 'CreateAnswerResponse':
          return CreateAnswerResponse.fromJson(value);
        case 'CreateAnswerResponseSelectedDocumentsInner':
          return CreateAnswerResponseSelectedDocumentsInner.fromJson(value);
        case 'CreateClassificationRequest':
          return CreateClassificationRequest.fromJson(value);
        case 'CreateClassificationResponse':
          return CreateClassificationResponse.fromJson(value);
        case 'CreateClassificationResponseSelectedExamplesInner':
          return CreateClassificationResponseSelectedExamplesInner.fromJson(value);
        ...
        case 'CreateCompletionResponseUsage':
          return CreateCompletionResponseUsage.fromJson(value);
        case 'CreateEditRequest':
          return CreateEditRequest.fromJson(value);
        case 'CreateEditResponse':
          return CreateEditResponse.fromJson(value);
        ...
        case 'CreateEmbeddingResponseDataInner':
          return CreateEmbeddingResponseDataInner.fromJson(value);
        case 'CreateEmbeddingResponseUsage':
          return CreateEmbeddingResponseUsage.fromJson(value);
        case 'CreateFineTuneRequest':
          return CreateFineTuneRequest.fromJson(value);
        ...
        case 'CreateSearchRequest':
          return CreateSearchRequest.fromJson(value);
        case 'CreateSearchResponse':
          return CreateSearchResponse.fromJson(value);
        case 'CreateSearchResponseDataInner':
          return CreateSearchResponseDataInner.fromJson(value);
        ...
        case 'FineTune':
          return FineTune.fromJson(value);
        case 'FineTuneEvent':
          return FineTuneEvent.fromJson(value);
        case 'ImagesResponse':
          return ImagesResponse.fromJson(value);
        case 'ImagesResponseDataInner':
          return ImagesResponseDataInner.fromJson(value);
        case 'ListEnginesResponse':
          return ListEnginesResponse.fromJson(value);
        case 'ListFilesResponse':
          return ListFilesResponse.fromJson(value);
        case 'ListFineTuneEventsResponse':
          return ListFineTuneEventsResponse.fromJson(value);
        case 'ListFineTunesResponse':
          return ListFineTunesResponse.fromJson(value);
